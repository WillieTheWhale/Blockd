...
class Settings(BaseSettings):
    ...
    RABBITMQ_USER: str = Field(default="", env="RABBITMQ_USER")  # Required: set RABBITMQ_USER env var
    RABBITMQ_PASSWORD: str = Field(default="", env="RABBITMQ_PASSWORD")  # Required: set RABBITMQ_PASSWORD env var
